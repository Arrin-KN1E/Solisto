...
bool polarity; 
byte myPins[] = {0, 1, 4, 5, 19, 21, 23};  // If using different number of LEDs it's just as simple as putting them in sequence in the array e.g.: byte myPins[] = {0, 1, 4, 5, 19, 21, 23, 25, 26};
// 0-(Yellow) STBY/ Reading LED, 1-(Orange) ERROR LED, 4-(Red) TX LED, 5-(Green) RX LED, 19-(Blue) Air Sensor LED, 21-(Green) Ground Sensor LED, 23-(White) Road Sensor LED
